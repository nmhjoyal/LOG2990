...
describe('AppComponent', () => {
  ...
  beforeEach((() => {
    ...
    'chooseEyedropper', 'chooseColourApplicator', 'chooseSelector', 'isUsingText', 'isUsingColourApplicator']);
  ...
  it('#toggleGrid should be called when g is pressed', () => {
    ...
    expect(elementRefMock.nativeElement.click).not.toHaveBeenCalled();
    onlyModalOpenSpy.and.returnValue(true);
    component.onKeydownG();
  ...
  it('#increaseSize should be called when Shift+ is pressed', () => {
    ...
    expect(gridServiceMock.increaseSize).not.toHaveBeenCalled();
    onlyModalOpenSpy.and.returnValue(true);
    component.onKeydownShiftPlus();
  ...
  it('#decreaseSize should be called when Shift- is pressed', () => {
    ...
    expect(gridServiceMock.decreaseSize).not.toHaveBeenCalled();
    onlyModalOpenSpy.and.returnValue(true);
    component.onKeydownShiftMinus();
