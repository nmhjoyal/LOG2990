export class IconLinks {
    static newDrawing = 'https://visualpharm.com/assets/375/Create-595b40b75ba036ed117d7bbf.svg';
    static crayon = 'https://i.imgur.com/ggPGxpn.png';
    static pen = 'https://i.imgur.com/WpG8Jy2.png';
    static bucket = 'https://i.imgur.com/Y0uukWJ.png';
